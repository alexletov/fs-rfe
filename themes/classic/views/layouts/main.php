...
<body>
    <div class="container main-part">
      ...
      <div class="well">
       <div style="text-align:center"><?php echo CHtml::image($image_url.'/images/en.png', 'Briefing image', array('class' => 'img-rounded')); ?></div></div>
       <div class="well">
...
<h2>Promo video</h2>
<div style="text-align:center"><iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/50TtrsiFGC4?rel=0" frameborder="0" allowfullscreen></iframe></div>
</div>
